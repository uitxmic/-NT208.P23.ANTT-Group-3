...
const PostManager = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Quản lý bài đăng | Đăng bán voucher, mã giảm giá | VoucherHub</title>
        <meta name="description" content="Quản lý bài đăng, đăng bán mã ưu đãi của bạn trên VoucherHub. Theo dõi, chỉnh sửa, xóa bài đăng dễ dàng." />
        <meta name="keywords" content="quản lý bài đăng, đăng bán mã ưu đãi, chỉnh sửa, xóa bài đăng, voucherhub" />
        <meta property="og:title" content="Quản lý bài đăng | Đăng bán voucher, mã giảm giá | VoucherHub" />
        <meta property="og:description" content="Quản lý bài đăng, đăng bán voucher, mã giảm giá, coupon của bạn trên VoucherHub." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://voucherhub.id.vn/posting-manager" />
        <meta property="og:image" content="https://voucherhub.id.vn/og-posting-manager.jpg" />
        <link rel="canonical" href="https://voucherhub.id.vn/posting-manager" />
        <script type="application/ld+json">{`
          {
            "@context": "https://schema.org",
            "@type": "WebPage",
            "name": "Quản lý bài đăng | VoucherHub",
            "description": "Quản lý bài đăng, đăng bán voucher, mã giảm giá, coupon của bạn trên VoucherHub.",
            "url": "https://voucherhub.id.vn/posting-manager"
          }
        `}</script>
      </Helmet>
      <Layout>
