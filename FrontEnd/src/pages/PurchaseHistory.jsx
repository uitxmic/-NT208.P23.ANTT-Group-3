...
const PurchaseHistory = () => {
    ...
    return (
        <>
            <Helmet>
                <title>Lịch sử mua voucher, coupon | VoucherHub</title>
                <meta name="description" content="Xem lịch sử mua, giao dịch voucher, coupon, mã giảm giá đã sử dụng tại VoucherHub." />
                <meta name="keywords" content="lịch sử mua, giao dịch voucher, giao dịch coupon, mã giảm giá đã mua, voucherhub" />
                <meta property="og:title" content="Lịch sử mua voucher, coupon | VoucherHub" />
                <meta property="og:description" content="Xem lịch sử mua, giao dịch voucher, coupon, mã giảm giá đã sử dụng tại VoucherHub." />
                <meta property="og:type" content="website" />
                <meta property="og:url" content="https://voucherhub.id.vn/purchase-history" />
                <link rel="canonical" href="https://voucherhub.id.vn/purchase-history" />
                {/* Schema WebPage */}
                <script type="application/ld+json">{`
                  {
                    ...
                    "@type": "WebPage",
                    "name": "Lịch sử mua",
                    "description": "Xem lịch sử mua, giao dịch voucher, mã giảm giá, coupon tại VoucherHub.",
                    "url": "https://voucherhub.id.vn/purchase-history"
                  }
                `}</script>
            </Helmet>
            <Layout>
