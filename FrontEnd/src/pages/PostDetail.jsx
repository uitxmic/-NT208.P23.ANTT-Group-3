...
const PostDetail = () => {
    ...
    return (
        <>
            <Helmet>
                <title>Chi tiết bài đăng | VoucherHub</title>
                <meta name="description" content="Xem chi tiết bài đăng, thông tin voucher, coupon, điều kiện áp dụng, hướng dẫn sử dụng tại VoucherHub." />
                <meta name="keywords" content="chi tiết bài đăng, thông tin voucher, điều kiện áp dụng, hướng dẫn sử dụng, coupon, voucherhub" />
                <meta property="og:title" content="Chi tiết bài đăng | VoucherHub" />
                <meta property="og:description" content="Xem chi tiết bài đăng, thông tin voucher, coupon, điều kiện áp dụng, hướng dẫn sử dụng tại VoucherHub." />
                <meta property="og:type" content="article" />
                <meta property="og:url" content={`https://voucherhub.id.vn/postdetail/${postId}`} />
                <link rel="canonical" href={`https://voucherhub.id.vn/postdetail/${postId}`} />
                {/* Schema Article */}
                <script type="application/ld+json">{`
                  {
                    ...
                    "description": "Chi tiết bài đăng, thông tin voucher, mã giảm giá, coupon tại VoucherHub.",
                    "url": "https://voucherhub.id.vn/postdetail/${postId}"
                  }
                `}</script>
            </Helmet>
            <Layout>
