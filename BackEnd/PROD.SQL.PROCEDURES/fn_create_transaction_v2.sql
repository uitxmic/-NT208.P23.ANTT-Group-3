...
DROP PROCEDURE IF EXISTS fn_create_transaction_v2;
$$
CREATE PROCEDURE fn_create_transaction_v2 (
    IN in_voucherId INT,
    IN in_postId INT,
    IN in_Amount INT,
    IN in_quantity INT,
...
BEGIN
    ...
    BEGIN
        ...
        VALUES ('SQLEXCEPTION occurred', NOW(), 'fn_create_transaction_v2', @sql_error_code, @sql_error_message);
        ROLLBACK;
        SELECT 'Created Failed' AS Message, -1 AS Id, @sql_error_code AS ErrorCode, @sql_error_message AS ErrorMessage;
    END;

    START TRANSACTION;
    
    INSERT INTO debug_log (log_message, log_time, procedure_name) 
    VALUES ('Bắt đầu kiểm tra đầu vào', NOW(), 'fn_create_transaction_v2');
    
    IF in_quantity <= 0 THEN
        SET v_error_message = 'Số lượng phải lớn hơn 0';
        INSERT INTO debug_log (log_message, log_time, procedure_name) 
        VALUES (v_error_message, NOW(), 'fn_create_transaction_v2');
    ...
    INSERT INTO debug_log (log_message, log_time, procedure_name) 
    VALUES ('Kiểm tra số dư người mua', NOW(), 'fn_create_transaction_v2');
    ...
    INSERT INTO debug_log (log_message, log_time, procedure_name) 
    VALUES ('Kiểm tra tên voucher', NOW(), 'fn_create_transaction_v2');
    ...
    INSERT INTO debug_log (log_message, log_time, procedure_name) 
    VALUES ('Kiểm tra số lượng bài đăng', NOW(), 'fn_create_transaction_v2');
    ...
    INSERT INTO debug_log (log_message, log_time, procedure_name) 
    VALUES ('Kiểm tra số lượng VoucherCode', NOW(), 'fn_create_transaction_v2');
    ...
    INSERT INTO debug_log (log_message, log_time, procedure_name) 
    VALUES ('Mở cursor VoucherCode', NOW(), 'fn_create_transaction_v2');
    ...
    read_loop: LOOP
        ...
        INSERT INTO debug_log (log_message, log_time, procedure_name) 
        VALUES (CONCAT('Insert Transaction cho VoucherCode: ', p_voucher_code), NOW(), 'fn_create_transaction_v2');
        ...
        INSERT INTO debug_log (log_message, log_time, procedure_name) 
        VALUES (CONCAT('Update Voucher cho VoucherCode: ', p_voucher_code), NOW(), 'fn_create_transaction_v2');
        ...
        INSERT INTO debug_log (log_message, log_time, procedure_name) 
        VALUES (CONCAT('Insert Noti cho Transaction: ', p_transaction_id), NOW(), 'fn_create_transaction_v2');
    ...
    INSERT INTO debug_log (log_message, log_time, procedure_name) 
    VALUES ('Cập nhật số lượng Post', NOW(), 'fn_create_transaction_v2');
    ...
    INSERT INTO debug_log (log_message, log_time, procedure_name) 
    VALUES ('Cập nhật số dư Seller', NOW(), 'fn_create_transaction_v2');
    ...
    INSERT INTO debug_log (log_message, log_time, procedure_name) 
    VALUES ('Cập nhật số dư Buyer', NOW(), 'fn_create_transaction_v2');
    ...
    INSERT INTO debug_log (log_message, log_time, procedure_name) 
    VALUES ('Commit transaction', NOW(), 'fn_create_transaction_v2');
...
DELIMITER ;
CALL fn_create_transaction_v2(5, 20, 1, 1, 29, 7);